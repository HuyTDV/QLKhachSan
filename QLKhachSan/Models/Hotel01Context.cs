...
public partial class Hotel01Context : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.PromotionId).HasName("PK__Promotio__52C42FC544BD7E16");
        ...
        modelBuilder.Entity<Room>(entity =>
        {
            ...
            // QUAN TRỌNG: Sửa d.Branch thành d.HotelBranch để khớp với Model Room.cs
            entity.HasOne(d => d.HotelBranch).WithMany(p => p.Rooms)
        ...
        modelBuilder.Entity<RoomMaintenance>(entity =>
        {
            ...
            entity.Property(e => e.MaintenanceDate).HasDefaultValueSql("(getdate())").HasColumnType("datetime");
            entity.Property(e => e.Status).HasMaxLength(50).HasDefaultValue("Pending");
        ...
        modelBuilder.Entity<UserLog>(entity =>
        {
            ...
            entity.Property(e => e.ActionTime).HasDefaultValueSql("(getdate())").HasColumnType("datetime");
